...
class Group(Enum):
    ...
    GC256A = b'\x00\x34' # [RFC9189]
    GC256B = b'\x00\x35' # [RFC9189]
    GC256C = b'\x00\x36' # [RFC9189]
    GC256D = b'\x00\x37' # [RFC9189]
    GC512A = b'\x00\x38' # [RFC9189]
    GC512B = b'\x00\x39' # [RFC9189]
    GC512C = b'\x00\x40' # [RFC9189]
    # curveSM2 = b'\x00\x29'
    # ffdhe2048 = b'\x01\x00'
    # ffdhe3072 = b'\x01\x01'
    # ffdhe4096 = b'\x01\x02'
...
class CipherSuite(Enum):
    ...
    TLS_GOSTR341112_256_WITH_28147_CNT_IMIT_OLD = b'\xFF\x85' # [RFC9189]
